...
/**
 * Jersey REST client generated for REST resource:FileFacadeREST [files]<br>
 *  USAGE:
 * <pre>
...
public class FileClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/TP_FINAL/resources";

    public FileClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("files");
    }
